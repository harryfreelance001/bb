          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-6">
            <div className="col-span-1">
              ...
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Cheese Meses</span>
                <span className="font-light">85K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Choco Crunch</span>
                <span className="font-light">95K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Almond Tiramisu</span>
                <span className="font-light">95K</span>
              </div>
            </div>
            <div className="col-span-1">
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Lotus Biscoff</span>
                <span className="font-light">98K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Lotus Hazelnut</span>
                <span className="font-light">99K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">5 Topping Mixed</span>
                <span className="font-light">99K</span>
              </div>
            </div>
          </div>
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-6">
            <div className="col-span-1">
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Happy Ied</span>
                <span className="font-light">130K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Family Ied</span>
                <span className="font-light">135K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Blue Ied</span>
                <span className="font-light">150K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Arabian</span>
                <span className="font-light">250K</span>
              </div>
            </div>
            <div className="col-span-1">
              <StaticImage
              ...
              />
              <div className="flex justify-between text-secondary mb-2 text-sm">
                <span className="font-medium">Lapis Legit</span>
                <span className="font-light">265K</span>
              </div>
            </div>
          </div>
          <a
